...
export default function page() {
    ...
    const fetchAgentsimages=async()=>{
        try{
          const result=await axios.get("http://localhost:8000/api/agentsimages/detail/"+ slug_img);
          console.log(result.data.agentsimages);
...
<div className="mx-auto w-36 h-36 relative mt-2 border-4 border-white bg-white rounded-full overflow-hidden">
    ...
    <div className="lg:max-w-lg lg:w-full mb-5 md:mb-0 md:w-1/2 w-3/6">
        <img className="object-cover object-center rounded w-[780px] h-full" alt="hero" src={`http://localhost:8000/images/gallery/${agentsimages.agents_img}`} />
    </div>
